...
-- obiekt1
INSERT INTO obiekty VALUES('obiekt1', ST_GeomFromEWKT('SRID=-1; COMPOUNDCURVE((0 1, 1 1),  CIRCULARSTRING(1 1, 2 0, 3 1), CIRCULARSTRING(3 1, 4 2, 5 1), (5 1, 6 1))'))
...
SELECT ST_AsText(ST_MakePolygon(
						ST_MakeLine((SELECT ST_LineMerge(geom) FROM obiekty WHERE nazwa='obiekt4'), 
...
INSERT INTO obiekty VALUES ('obiekt7', ST_Union(
						(SELECT ST_AsText(geom) FROM obiekty WHERE nazwa='obiekt3'),
